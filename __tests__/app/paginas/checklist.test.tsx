...
import TelaChecklist from '../../../src/app/paginas/checklist';
...
describe('<TelaChecklist />', () => {
  ...
  it('matches last snapshot', () => {
    const route = useRoute<RouteProp<AuthNavigatorParamsList, AuthRoutes.Checklist>>();

    const tree: any = renderer.create(
      <ThemeProvider theme={Themes.light}>
        <TelaChecklist route={route} navigation={useNavigation()} />
      </ThemeProvider>
    ).toJSON();
