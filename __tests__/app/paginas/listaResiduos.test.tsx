...
import TelaListaResiduos from '../../../src/app/paginas/listaResiduos';
...
describe('<TelaListaResiduos />', () => {
  ...
  it('matches last snapshot', () => {
    const route = useRoute<RouteProp<AuthNavigatorParamsList, AuthRoutes.ListaResiduos>>();

    const tree: any = renderer.create(
      <ThemeProvider theme={Themes.light}>
        <TelaListaResiduos route={route} navigation={useNavigation()} />
      </ThemeProvider>,
    ).toJSON();
